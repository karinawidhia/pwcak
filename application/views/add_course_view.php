...
<!----->
       ...
       <div class="content-main">
		...
		<div class="grid-system">
			<div class="horz-grid">
		 		<div class="grid-hor">
		 			<h3 id="grid-example-basic"><input type="text" name="titlecourse" placeholder="Your Title" style="padding: 8px;text-align: center;"></h3>
		 			<br>
		 			<textarea name="addcourse" class="ckeditor" id="ckeditor"></textarea>
				</div>
